// ============================================================
// NEW FILE: components/admin/tenants/tenant-management-page.tsx
...
import { useTenants } from '@/hooks/useTenants'; // Hook para buscar e gerenciar tenants
...
export default function TenantManagementPage() {
    ...
    // Atualiza os filtros do hook quando os filtros locais (ou debounce) mudam
    React.useEffect(() => {
